...
{
    BL_PROFILE("amr-wind::FPlaneAveraging::compute_line_derivatives");
    for (int i = 0; i < m_ncell_line; ++i) {
        for (int n = 0; n < m_ncomp; ++n) {
...
{
    BL_PROFILE("amr-wind::FPlaneAveraging::line_derivative_of_average_cell");
...
{
    BL_PROFILE("amr-wind::FPlaneAveraging::line_derivative_interpolated");
